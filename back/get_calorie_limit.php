...
(SELECT value FROM params WHERE code = 'calorie_deficit_procent') calorie_deficit_procent");
...
$height = (int)$row[1];
$age = (int)$row[2];
$calorie_deficit_procent = (float)$row[3];

$calorie_deficit = 1 - $calorie_deficit_procent / 100;
