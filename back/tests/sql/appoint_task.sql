-- Проверка назначения следующего задания (кейс 1)
...
-- Проверка назначения следующего задания с промежуточными удалённым и неактивным (кейс 2)
INSERT INTO `tasks` (`id`, `text`, `next_task_id`, `next_task_break`, `creation_date`, `end_date`, `category_id`, `offset`, `duration`, `active`, `deleted`, `cooldown`, `important`) VALUES
...
-- Проверка назначения следующего задания с наличием задания на время  (кейсы 3-5)
INSERT INTO `tasks` (`id`, `text`, `next_task_id`, `next_task_break`, `creation_date`, `end_date`, `category_id`, `offset`, `duration`, `active`, `deleted`, `cooldown`, `important`) VALUES
...
(9, 'Задание 9 (разовое, со временем)', NULL, NULL, '2000-01-01 06:00:00', NULL, 1, 10, 10, 1, 0, 0, 0);
...
-- Проверка назначения следующего задания при разной периодичности заданий (кейсы 6-7)
INSERT INTO `tasks` (`id`, `text`, `next_task_id`, `next_task_break`, `creation_date`, `end_date`, `category_id`, `offset`, `duration`, `active`, `deleted`, `cooldown`, `important`) VALUES
...
-- Проверка назначения следующего задания при наличии в цепочке важного задания на время (кейсы 8-10)
INSERT INTO `tasks` (`id`, `text`, `next_task_id`, `next_task_break`, `creation_date`, `end_date`, `category_id`, `offset`, `duration`, `active`, `deleted`, `cooldown`, `important`) VALUES
...
-- Проверка назначения следующего задания после полуночи при наличии в цепочке важного задания на время (кейсы 11-12)
INSERT INTO `tasks` (`id`, `text`, `next_task_id`, `next_task_break`, `creation_date`, `end_date`, `category_id`, `offset`, `duration`, `active`, `deleted`, `cooldown`, `important`) VALUES
...
-- Проверка назначения следующего задания после полуночи при наличии в цепочке важного задания на время (кейсы 13-15)
INSERT INTO `tasks` (`id`, `text`, `next_task_id`, `next_task_break`, `creation_date`, `end_date`, `category_id`, `offset`, `duration`, `active`, `deleted`, `cooldown`, `important`) VALUES
...
-- Проверка назначения следующего задания при наличии в цепочке неважного задания на время (кейсы 8-10)
INSERT INTO `tasks` (`id`, `text`, `next_task_id`, `next_task_break`, `creation_date`, `end_date`, `category_id`, `offset`, `duration`, `active`, `deleted`, `cooldown`, `important`) VALUES
...
-- Проверка назначения следующего задания после полуночи при наличии в цепочке неважного задания на время (кейсы 11-12)
INSERT INTO `tasks` (`id`, `text`, `next_task_id`, `next_task_break`, `creation_date`, `end_date`, `category_id`, `offset`, `duration`, `active`, `deleted`, `cooldown`, `important`) VALUES
