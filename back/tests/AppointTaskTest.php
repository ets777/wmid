...
final class AppointTaskTest extends TestCase
{
    ...
    public function providerAppointTask()
    {
        ...
        return array(
            ...
            array($test_db, '06:39:00', '2000-01-01', 3, new Appointment_result(8), "3. Назначение следующего задания с наличием важного задания на время, когда времени достаточно"),
            array($test_db, '06:40:00', '2000-01-01', 3, new Appointment_result(0), "4. Назначение следующего задания с наличием важного задания на время, когда времени не достаточно, но выполнять задание на время ещё рано"),
            array($test_db, '06:51:00', '2000-01-01', 3, new Appointment_result(9), "5. Назначение следующего задания с наличием важного задания на время, когда времени не достаточно, и можно начать выполнять задание на время"),
