...
final class AppointTaskTest extends TestCase
{
    ...
    public function providerAppointTask()
    {
        ...
        return array(
            ...
            array($test_db, '06:58:00', '2000-01-02', 7, new Appointment_result(13), "8. Назначение следующего задания при наличии задания на время в цепочке и достаточном времени"),
            array($test_db, '06:59:00', '2000-01-02', 7, new Appointment_result(14), "9. Назначение следующего задания при наличии задания на время в цепочке и недостаточном времени"),
            array($test_db, '07:01:00', '2000-01-02', 7, new Appointment_result(14), "10. Назначение следующего задания при наличии задания на время в цепочке и просрочке"),
            array($test_db, '23:59:00', '2000-01-02', 8, new Appointment_result(17), "11. Назначение следующего задания при наличии задания на время в цепочке до полуночи"),
            array($test_db, '00:01:00', '2000-01-03', 8, new Appointment_result(17), "12. Назначение следующего задания при наличии задания на время в цепочке после полуночи"),
            ...
            array($test_db, '09:01:00', '2000-01-02', 9, new Appointment_result(19), "15. Назначение следующего задания при выполнении задания на время с опозданием")
        );
    }
}
