...
(2, 'Задание 2 (разовое, есть предыдущее)', null, null, null, null, 1, 0, 1, 1, 0, 0, 0, 1),
(1, 'Задание 1 (разовое, есть следующее)', 2, null, null, null, 1, 0, 1, 1, 0, 0, 0, 1);
...
insert into tsk_tasks (id, text, nextTaskId, nextTaskBreak, startDate, endDate, categoryId, offset, duration, isActive, isDeleted, cooldown, isImportant, userId) values
(6, 'Задание 6 (разовое, есть предыдущее)', null, null, null, null, 1, 0, 1, 1, 0, 0, 0, 1),
(5, 'Задание 5 (разовое, есть следующее)', 6, null, null, null, 1, 0, 1, 0, 1, 0, 0, 1),
(4, 'Задание 4 (разовое, есть следующее удалённое)', 5, null, null, null, 1, 0, 1, 0, 0, 0, 0, 1),
(3, 'Задание 3 (разовое, есть следующее неактивное)', 4, null, null, null, 1, 0, 1, 1, 0, 0, 0, 1);
...
insert into tsk_tasks (id, text, nextTaskId, nextTaskBreak, startDate, endDate, categoryId, offset, duration, isActive, isDeleted, cooldown, isImportant, userId) values
(9, 'Задание 9 (разовое, со временем, важное)', null, null, null, null, 1, 10, 10, 1, 0, 0, 1, 1),
(8, 'Задание 8 (разовое, есть предыдущее)', null, null, null, null, 1, 0, 10, 1, 0, 0, 0, 1),
(7, 'Задание 7 (разовое, есть следующее)', 8, null, null, null, 1, 0, 10, 1, 0, 0, 0, 1);
...
insert into tsk_tasks (id, text, nextTaskId, nextTaskBreak, startDate, endDate, categoryId, offset, duration, isActive, isDeleted, cooldown, isImportant, userId) values
(11, 'Задание 11 (еженедельное, есть предыдущее)', null, null, null, null, 1, 0, 1, 1, 0, 0, 0, 1),
(10, 'Задание 10 (ежедневное, есть следующее)', 11, null, '2000-01-03', '2000-01-03', 1, 0, 1, 1, 0, 0, 0, 1);
...
insert into tsk_tasks (id, text, nextTaskId, nextTaskBreak, startDate, endDate, categoryId, offset, duration, isActive, isDeleted, cooldown, isImportant, userId) values
(14, 'Задание 14 (разовое, важное, со временем, есть предыдущее)', null, null, null, null, 1, 0, 1, 1, 0, 0, 1, 1),
(13, 'Задание 13 (разовое, есть следующее)', 14, null, null, null, 1, 0, 1, 1, 0, 0, 0, 1),
(12, 'Задание 12 (разовое, есть следующее)', 13, null, null, null, 1, 0, 1, 1, 0, 0, 0, 1);
...
insert into tsk_tasks (id, text, nextTaskId, nextTaskBreak, startDate, endDate, categoryId, offset, duration, isActive, isDeleted, cooldown, isImportant, userId) values
(17, 'Задание 17 (разовое, важное, со временем, есть предыдущее)', null, null, null, null, 1, 0, 1, 1, 0, 0, 1, 1),
(16, 'Задание 16 (разовое, есть следующее)', 17, null, null, null, 1, 0, 1, 1, 0, 0, 0, 1),
(15, 'Задание 15 (разовое, есть следующее)', 16, null, null, null, 1, 0, 1, 1, 0, 0, 0, 1);
...
insert into tsk_tasks (id, text, nextTaskId, nextTaskBreak, startDate, endDate, categoryId, offset, duration, isActive, isDeleted, cooldown, isImportant, userId) values
(19, 'Задание 19 (разовое)', null, null, null, null, 1, 0, 5, 1, 0, 0, 0, 1),
(18, 'Задание 18 (разовое, со временем, есть следующее)', 19, null, null, 0, 1, 10, 1, 1, 0, 0, 0, 1);
...
insert into tsk_tasks (id, text, nextTaskId, nextTaskBreak, startDate, endDate, categoryId, offset, duration, isActive, isDeleted, cooldown, isImportant, userId) values
(22, 'Задание 22 (разовое, неважное, со временем, есть предыдущее)', null, null, null, null, 1, 0, 1, 1, 0, 0, 0, 1),
(21, 'Задание 21 (разовое, есть следующее)', 22, null, null, null, 1, 0, 1, 1, 0, 0, 0, 1),
(20, 'Задание 20 (разовое, есть следующее)', 21, null, null, null, 1, 0, 1, 1, 0, 0, 0, 1);
...
insert into tsk_tasks (id, text, nextTaskId, nextTaskBreak, startDate, endDate, categoryId, offset, duration, isActive, isDeleted, cooldown, isImportant, userId) values
(25, 'Задание 25 (разовое, неважное, со временем, есть предыдущее)', null, null, null, null, 1, 0, 1, 1, 0, 0, 0, 1),
(24, 'Задание 24 (разовое, есть следующее)', 25, null, null, null, 1, 0, 1, 1, 0, 0, 0, 1),
(23, 'Задание 23 (разовое, есть следующее)', 24, null, null, null, 1, 0, 1, 1, 0, 0, 0, 1);
...
insert into tsk_tasks (id, text, nextTaskId, nextTaskBreak, startDate, endDate, categoryId, offset, duration, isActive, isDeleted, cooldown, isImportant, userId) values
(29, 'Задание 29 (разовое, со временем, неважное)', null, null, null, null, 1, 10, 10, 1, 0, 0, 0, 1),
(28, 'Задание 28 (разовое, есть предыдущее)', null, null, null, null, 1, 0, 10, 1, 0, 0, 0, 1),
(27, 'Задание 27 (разовое, есть следующее)', 28, null, null, null, 1, 0, 10, 1, 0, 0, 0, 1);
...
insert into tsk_tasks (id, text, nextTaskId, nextTaskBreak, startDate, endDate, categoryId, offset, duration, isActive, isDeleted, cooldown, isImportant, userId) values
(32, 'Задание 32 (разовое)', null, null, null, null, 1, 10, 10, 1, 0, 0, 0, 1),
(31, 'Задание 31 (разовое, есть предыдущее)', null, null, '2000-01-06', '2000-01-06', 1, 0, 10, 1, 0, 0, 0, 1),
(30, 'Задание 30 (разовое, есть следующее отложенное)', 31, 10, null, null, 1, 0, 10, 1, 0, 0, 0, 1);
...
(15, '2000-01-06 05:00:00', null, 3, 31, 0);

-- Проверка назначения следующего задания при наличии в цепочке удалённого задания (кейс 1.26)
insert into tsk_tasks (id, text, nextTaskId, nextTaskBreak, startDate, endDate, categoryId, offset, duration, isActive, isDeleted, cooldown, isImportant, userId) values
(35, 'Задание 35 (разовое, есть предыдущее)', null, null, null, null, 1, 10, 10, 1, 0, 0, 0, 1),
(34, 'Задание 34 (разовое, удалённое, есть предыдущее)', 35, null, null, null, 1, 0, 10, 1, 1, 0, 0, 1),
(33, 'Задание 33 (разовое, есть следующее)', 34, null, null, null, 1, 0, 10, 1, 0, 0, 0, 1);
